...
local theme = lush(function(injected_functions)
  ...
  -- the main spectrum/gradient goes from dark to light and consists

  -- local color_main = hsl("#46549b")

  -- local color_main = hsl("#0000ff").rotate(-15).desaturate(50).darken(30)
  -- local color_secondary = color_main.lighten(60)
  -- local color_thirdary = color_secondary.lighten(80)

  -- local color01 = color_thirdary
  -- local color02 = color01.darken(10)
  -- local color03 = color02.darken(10)

  -- local color04 = color_secondary
  -- local color05 = color04.darken(10)
  -- local color06 = color05.darken(10)
  -- local color07 = color06.darken(10)

  -- local color08 = color_main
  -- local color09 = color08.darken(10)
  -- local color10 = color09.darken(10)
  -- local color11 = color10.darken(40)
